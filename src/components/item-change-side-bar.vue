<template>
  ...
  >
      ...
      <div class="">
        <div v-if="store.count > 0">
          ...
          <section class="mt-16 flex gap-7">
            ...
            <div class="border border-gray-500 py-1 px-5 rounded-md flex gap-10 items-center">
    ...
    <div class="p-4 border-t" v-if="store.count > 0">
        <div class="mb-5">
      <span class="text-lg font-medium mb-4 text-center ml-">Estimated total</span>
      <span class="opacity-50 absolute right-4">${{ store.price30 }} USD</span>
    </div>
      <button
