<template>
  ...
  const outOfStock = ['Small', '', '', 'Xlarge', '2Xlarge'];
  ...
  const mainImages = [
  "https://kdmv.io/cdn/shop/files/6-1_0004_5-1.jpg?v=1725215743&width=713",
  "https://kdmv.io/cdn/shop/files/2-1_0000_SDACHGAME_0008_Generative_Fill.jpg?v=1725214625&width=713",
  "https://kdmv.io/cdn/shop/files/2-1_0007_KDMV_-_LOOKBOOK7507.jpg?v=1725214624&width=713",
  "https://kdmv.io/cdn/shop/files/6-1_0003_5-2.jpg?v=1725215743&width=713"
];
